...
def weather_report(weather)
  ...
  return "The weather in #{location} is #{description}. The temperature is #{temp} degrees Farenheit."
end 
...
def city_weather_info(weather)
  weather.each do |thing, data|
    puts "The #{thing} is #{data}"
  end # do
end # def
...
def convert_temp(weather)
  cel=  temp= (weather[:temperature_farenheit] - 32.00) * 5.00 / 9.00
  return cel.round(2)
end 
